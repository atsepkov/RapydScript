...
desugar_kwargs = function ՐՏ_desugar_kwargs() {
    ...
    return function() {
        ...
        for (var i = 0; i < arguments.length; i++) {
            var ՐՏ_Iter7 = ՐՏ_Iterable(Object.keys(arguments[i]));
            for (var ՐՏ_Index7 = 0; ՐՏ_Index7 < ՐՏ_Iter7.length; ՐՏ_Index7++) {
                prop = ՐՏ_Iter7[ՐՏ_Index7];
