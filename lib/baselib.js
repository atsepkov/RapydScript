...
function ՐՏ_rebindAll(thisArg, rebind) {
    ...
    function getmethods(obj) {
        var cur, prop_names, descriptor, proto, base_proto, obj_proto, methods, props, pname, meth;
        cur = obj;
        ...
        while (cur && !(cur === base_proto || cur === obj_proto)) {
            ...
            for (var idx in props) {
                pname = props[idx];
                if (pname === "constructor" || pname === "__init__" || pname === "__base__") {
                    continue;
                }
                if (!methods[pname] && (meth = descriptor(cur, pname)) && (meth = meth.value) && meth.apply) {
                    methods[pname] = meth;
                }
            }
            cur = proto(cur);
