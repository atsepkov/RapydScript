var RAPYD_PREFIX, NATIVE_CLASSES, COMMON_STATIC, CLASS_MAP, BASELIB, STDLIB, UNARY_PREFIX, ASSIGNMENT, PRECEDENCE, STATEMENTS_WITH_LABELS, ATOMIC_START_TOKEN, DANGER_ZONE;
RAPYD_PREFIX = "ՐՏ";
NATIVE_CLASSES = {
    "Image": {},
    "RegExp": {},
...
function parse($TEXT, options) {
    var ՐՏ_Temp, options, module_id, import_dirs, IMPORTED, IMPORTING, S, cname, obj;
    ...
    if (options.classes) {
        var ՐՏ_Iter0 = ՐՏ_Iterable(options.classes);
        for (var ՐՏ_Index0 = 0; ՐՏ_Index0 < ՐՏ_Iter0.length; ՐՏ_Index0++) {
            cname = ՐՏ_Iter0[ՐՏ_Index0];
    ...
    var is_nested_comparison = (ՐՏ1 = function is_nested_comparison(stmt) {
    ...
    }, Object.defineProperty(ՐՏ1, "__doc__", {
        ...
        if (Array.isArray(body)) {
            for (name in body) {
                ...
                if (obj instanceof AST_Function || obj instanceof AST_Class) {
                    ...
                    var ՐՏ_Iter2 = ՐՏ_Iterable([ "body", "alternative" ]);
    ...
    var statement = (ՐՏ3 = function statement() {
    ...
    function get_class_in_scope(expr) {
        ...
        if (expr instanceof AST_SymbolRef) {
            ...
            var ՐՏ_Iter5 = ՐՏ_Iterable(range(S.in_scope.length - 1, -1, -1));
            for (var ՐՏ_Index5 = 0; ՐՏ_Index5 < ՐՏ_Iter5.length; ՐՏ_Index5++) {
                s = ՐՏ_Iter5[ՐՏ_Index5];
            ...
            if (expr instanceof AST_SymbolRef) {
                ...
                if (len(referenced_path) > 1) {
                    ...
                    var ՐՏ_Iter6 = ՐՏ_Iterable(range(S.in_scope.length - 1, -1, -1));
                    for (var ՐՏ_Index6 = 0; ՐՏ_Index6 < ՐՏ_Iter6.length; ՐՏ_Index6++) {
                        s = ՐՏ_Iter6[ՐՏ_Index6];
    ...
    function do_import(key) {
        var ՐՏ_Temp, package_module_id, filename, src_code, modpath, location, data, contents;
        ...
        function safe_read(base_path) {
            var ՐՏ_Temp, i, path;
            var ՐՏ_Iter7 = ՐՏ_Iterable(enumerate([ base_path + ".pyj", base_path + "/__init__.pyj" ]));
            for (var ՐՏ_Index7 = 0; ՐՏ_Index7 < ՐՏ_Iter7.length; ՐՏ_Index7++) {
                var ՐՏ_Unpack7 = ՐՏ_Iter7[ՐՏ_Index7];
                i = ՐՏ_Unpack7[0];
                path = ՐՏ_Unpack7[1];
                try {
        ...
        modpath = key.replace(".", "/");
        var ՐՏ_Iter8 = ՐՏ_Iterable(import_dirs);
        for (var ՐՏ_Index8 = 0; ՐՏ_Index8 < ՐՏ_Iter8.length; ՐՏ_Index8++) {
            location = ՐՏ_Iter8[ՐՏ_Index8];
            if (location) {
                var ՐՏ_Unpack9 = safe_read(location + "/" + modpath);
                data = ՐՏ_Unpack9[0];
                filename = ՐՏ_Unpack9[1];
                if (data !== null) {
                    src_code = data;
                    break;
                }
    ...
    function import_(from_import) {
        var ՐՏ_Temp, ans, name, tmp, key, alias, imp, classes, argnames, aname, argvar, obj, i;
        ans = new AST_Imports({
            "imports": []
        });
        while (true) {
        ...
        var ՐՏ_Iter10 = ՐՏ_Iterable(ans["imports"]);
        for (var ՐՏ_Index10 = 0; ՐՏ_Index10 < ՐՏ_Iter10.length; ՐՏ_Index10++) {
            imp = ՐՏ_Iter10[ՐՏ_Index10];
            do_import(imp.key);
            ...
            if (from_import) {
                ...
                var ՐՏ_Iter11 = ՐՏ_Iterable(argnames);
                for (var ՐՏ_Index11 = 0; ՐՏ_Index11 < ՐՏ_Iter11.length; ՐՏ_Index11++) {
                    argvar = ՐՏ_Iter11[ՐՏ_Index11];
    ...
    function class_() {
        var ՐՏ_Temp, start, name, externaldecorator, class_details, docstring, definition, i, stmt, class_var_names, visitor;
        start = prev();
        ...
        visitor = new walker();
        var ՐՏ_Iter13 = ՐՏ_Iterable(definition.body);
        for (var ՐՏ_Index13 = 0; ՐՏ_Index13 < ՐՏ_Iter13.length; ՐՏ_Index13++) {
            stmt = ՐՏ_Iter13[ՐՏ_Index13];
    ...
    function function_(in_class, ctor) {
        var ՐՏ_Temp, start, is_accessor, name, generator, localvars, staticmethod, function_args, return_annotation, has_special_decorator, ctor, docstring, definition;
        start = prev();
        ...
        definition = new ctor({
            ...
            name: name,
            argnames: function(a) {
                var ՐՏ_Temp, defaults, first, seen_names, def_line, val;
                defaults = {};
                first = true;
                seen_names = {};
                def_line = S.input.context().tokline;
                function get_arg() {
                    var ՐՏ_Temp, name_token, name_ctx, ntok, annotation, sym;
                    ...
                    if (ntok.type === "punc" && ntok.value === ":") {
                        ...
                        function_args[sym.name] = sym.annotation && ՐՏ_in(sym.annotation.name, NATIVE_CLASSES) ? sym.annotation.name : "?";
                        return sym;
                    } else {
                        if (!is_("name")) {
            ...
            body: function(loop, labels) {
                ...
                localvars = (function() {
                    var ՐՏ_Iter = ՐՏ_Iterable(Object.keys(S.in_scope[S.in_scope.length-1].vars)), ՐՏ_Result = [], variable;
                    for (var ՐՏ_Index = 0; ՐՏ_Index < ՐՏ_Iter.length; ՐՏ_Index++) {
                        variable = ՐՏ_Iter[ՐՏ_Index];
                        if (!(ՐՏ_in(variable, S.in_scope[S.in_scope.length-1].nonlocal))) {
                            ՐՏ_Result.push(new_symbol(AST_SymbolVar, variable));
                        }
                    }
                    return ՐՏ_Result;
                })();
        ...
        if (in_class && !staticmethod && definition.argnames.length < 1) {
    ...
    function format_docstring(string) {
        var ՐՏ_Temp, lines, indent, line, pad, trimmed;
        lines = string.split(/\n/g);
        indent = 1e6;
        var ՐՏ_Iter14 = ՐՏ_Iterable(lines.slice(1));
        for (var ՐՏ_Index14 = 0; ՐՏ_Index14 < ՐՏ_Iter14.length; ՐՏ_Index14++) {
            line = ՐՏ_Iter14[ՐՏ_Index14];
            if (line.trim().length) {
                pad = line.match(/^\s*/)[0];
        ...
        if (indent < 1e6) {
            var ՐՏ_Iter15 = ՐՏ_Iterable(lines.slice(1));
            for (var ՐՏ_Index15 = 0; ՐՏ_Index15 < ՐՏ_Iter15.length; ՐՏ_Index15++) {
                line = ՐՏ_Iter15[ՐՏ_Index15];
    ...
    function as_atom_node(token) {
        var ՐՏ_Temp, tok, tmp_, token, ret, tmp__;
        tok = token || S.token;
        tmp_ = tok.type;
        if (tmp_ === "name") {
    ...
    function expr_list(closing, allow_trailing_comma, allow_empty, func_call) {
        ...
        if (func_call) {
            tmp = [];
            tmp.kwargs = [];
            var ՐՏ_Iter16 = ՐՏ_Iterable(enumerate(a));
            for (var ՐՏ_Index16 = 0; ՐՏ_Index16 < ՐՏ_Iter16.length; ՐՏ_Index16++) {
                var ՐՏ_Unpack16 = ՐՏ_Iter16[ՐՏ_Index16];
                i = ՐՏ_Unpack16[0];
                arg = ՐՏ_Unpack16[1];
    ...
    var array_ = (ՐՏ17 = function array_() {
    ...
    }, ՐՏ17 = embed_tokens(ՐՏ17), ՐՏ17);
    
    var object_ = (ՐՏ18 = function object_() {
        var ՐՏ_Temp, maybe_dict_comprehension, first, a, start, type, computed, saw_starargs, key, name, ctx, orig, key_;
    ...
    function maybe_assign(no_in) {
        var ՐՏ_Temp, start, left, val, right;
        start = S.token;
    ...
    function expression(commas, no_in) {
        var ՐՏ_Temp, start, expr, left, leftAst, right, index, element, seq;
        start = S.token;
        ...
        if (commas) {
            ...
            while (is_("punc", ",") && !peek().nlb) {
                ...
                if (expr instanceof AST_Assign) {
                    ...
                    var ՐՏ_Iter19 = ՐՏ_Iterable(enumerate(leftAst.elements));
                    for (var ՐՏ_Index19 = 0; ՐՏ_Index19 < ՐՏ_Iter19.length; ՐՏ_Index19++) {
                        var ՐՏ_Unpack19 = ՐՏ_Iter19[ՐՏ_Index19];
                        index = ՐՏ_Unpack19[0];
                        element = ՐՏ_Unpack19[1];
            ...
            if (left.length > 1 && left[left.length-1] instanceof AST_Assign) {
                left[left.length-1] = left[left.length-1].left;
                var ՐՏ_Iter20 = ՐՏ_Iterable(enumerate(left));
                for (var ՐՏ_Index20 = 0; ՐՏ_Index20 < ՐՏ_Iter20.length; ՐՏ_Index20++) {
                    var ՐՏ_Unpack20 = ՐՏ_Iter20[ՐՏ_Index20];
                    index = ՐՏ_Unpack20[0];
                    element = ՐՏ_Unpack20[1];
            ...
            seq = function build_seq(a) {
                var ՐՏ_Temp, first, index, element;
                first = a.shift();
                if (first instanceof AST_Assign) {
                    if (first.left instanceof AST_Array) {
                        var ՐՏ_Iter21 = ՐՏ_Iterable(enumerate(first.left.elements));
                        for (var ՐՏ_Index21 = 0; ՐՏ_Index21 < ՐՏ_Iter21.length; ՐՏ_Index21++) {
                            var ՐՏ_Unpack21 = ՐՏ_Iter21[ՐՏ_Index21];
                            index = ՐՏ_Unpack21[0];
                            element = ՐՏ_Unpack21[1];
    ...
    return function() {
        var ՐՏ_Temp, start, body, docstring, first_token, element, shebang, end, toplevel, assignments, callables;
        start = S.token;
        body = [];
        docstring = null;
        first_token = true;
