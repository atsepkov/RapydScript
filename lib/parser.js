...
function parse($TEXT, options) {
    ...
    var statement = (ՐՏ_2 = function statement() {
        var tmp_, dir, stat, start, func, chain, ctor, tmp;
    ...
    function class_() {
        var ՐՏitr11, ՐՏidx11;
        var start, name, externaldecorator, class_details, docstring, definition, i, stmt, class_var_names, visitor;
        start = prev();
    ...
    function subscripts(expr, allow_calls) {
        var start, slice_bounds, is_slice, i, str_, ret, c, funcname, tmp_, args;
        start = expr.start;
        if (is_("punc", ".")) {
            next();
    ...
    function expression(commas, no_in) {
        var ՐՏitr17, ՐՏidx17, ՐՏupk5, ՐՏitr18, ՐՏidx18, ՐՏupk6;
        ...
        if (commas) {
            ...
            while (is_("punc", ",") && !peek().newline_before) {
                ...
                if (expr instanceof AST_Assign) {
                    ...
                    ՐՏitr17 = ՐՏ_Iterable(enumerate(leftAst.elements));
                    for (ՐՏidx17 = 0; ՐՏidx17 < ՐՏitr17.length; ՐՏidx17++) {
                        ՐՏupk5 = ՐՏitr17[ՐՏidx17];
                        index = ՐՏupk5[0];
                        element = ՐՏupk5[1];
            ...
            if (left.length > 1 && left[left.length-1] instanceof AST_Assign) {
                left[left.length-1] = left[left.length-1].left;
                ՐՏitr18 = ՐՏ_Iterable(enumerate(left));
                for (ՐՏidx18 = 0; ՐՏidx18 < ՐՏitr18.length; ՐՏidx18++) {
                    ՐՏupk6 = ՐՏitr18[ՐՏidx18];
                    index = ՐՏupk6[0];
                    element = ՐՏupk6[1];
