...
function parse($TEXT, options) {
    ...
    function function_(in_class, ctor) {
        var ՐՏ_Temp, is_accessor, name, generator, localvars, staticmethod, function_args, return_annotation, has_special_decorator, ctor, definition;
    ...
    var object_ = embed_tokens(function object_() {
        var ՐՏ_Temp, maybe_dict_comprehension, first, a, start, type, computed, saw_starargs, value, key, name, ctx, orig, key_;
