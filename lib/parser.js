...
function parse($TEXT, options) {
    var ՐՏ_Temp, options, module_id, import_dirs, IMPORTED, IMPORTING, S, cname, obj, statement, import_, class_, function_, nonlocal_, const_, new_, expr_atom, array_, subscripts, maybe_unary, expr_op, maybe_conditional, maybe_assign, expression;
    ...
    function for_in(init, list_comp) {
        ...
        if (init instanceof AST_Array) {
            var ՐՏ_Iter2 = ՐՏ_Iterable(init.elements);
    ...
    function_ = function(in_class, ctor) {
        var ՐՏ_Temp, is_accessor, name, generator, localvars, staticmethod, function_args, return_annotation, has_special_decorator, ctor;
    ...
    var object_ = embed_tokens(function object_() {
        var ՐՏ_Temp, maybe_dict_comprehension, first, a, start, type, key, name, ctx, orig, quoted;
                ...
                if (expr instanceof AST_Assign) {
                    ...
                    if (left.length === 1) {
                        if (left[0] instanceof AST_Seq) {
                            ...
                            var ՐՏ_Iter13 = ՐՏ_Iterable(leftAst);
                            for (var ՐՏ_Index13 = 0; ՐՏ_Index13 < ՐՏ_Iter13.length; ՐՏ_Index13++) {
                                element = ՐՏ_Iter13[ՐՏ_Index13];
                                mark_local_assignment(element);
                            }
                        } else {
                            leftAst = left[0];
