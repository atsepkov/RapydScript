...
function parse($TEXT, options) {
    var ՐՏ_Temp, options, module_id, import_dirs, IMPORTED, IMPORTING, S, cname, obj, import_, class_, function_, nonlocal_, const_, new_, expr_atom, subscripts, maybe_unary, expr_op, maybe_conditional, maybe_assign, expression;
