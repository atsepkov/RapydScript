...
function parse($TEXT, options) {
        ...
        if (Array.isArray(body)) {
            for (name in body) {
                ...
                if (obj instanceof AST_Function || obj instanceof AST_Class) {
                    ...
                    var ՐՏ_Iter1 = ՐՏ_Iterable([ "body", "alternative" ]);
                    for (var ՐՏ_Index1 = 0; ՐՏ_Index1 < ՐՏ_Iter1.length; ՐՏ_Index1++) {
                        x = ՐՏ_Iter1[ՐՏ_Index1];
                        opt = obj[x];
                        if (opt) {
    ...
    function for_in(init, list_comp) {
        ...
        if (init instanceof AST_Array) {
            var ՐՏ_Iter2 = ՐՏ_Iterable(enumerate(init.elements));
            for (var ՐՏ_Index2 = 0; ՐՏ_Index2 < ՐՏ_Iter2.length; ՐՏ_Index2++) {
                var ՐՏ_Unpack2 = ՐՏ_Iter2[ՐՏ_Index2];
                i = ՐՏ_Unpack2[0];
                element = ՐՏ_Unpack2[1];
                value = null;
    ...
    function get_class_in_scope(expr) {
        ...
        if (expr instanceof AST_SymbolRef) {
            ...
            var ՐՏ_Iter3 = ՐՏ_Iterable(range(S.in_scope.length - 1, -1, -1));
            for (var ՐՏ_Index3 = 0; ՐՏ_Index3 < ՐՏ_Iter3.length; ՐՏ_Index3++) {
                s = ՐՏ_Iter3[ՐՏ_Index3];
            ...
            if (expr instanceof AST_SymbolRef) {
                ...
                if (len(referenced_path) > 1) {
                    ...
                    var ՐՏ_Iter4 = ՐՏ_Iterable(range(S.in_scope.length - 1, -1, -1));
                    for (var ՐՏ_Index4 = 0; ՐՏ_Index4 < ՐՏ_Iter4.length; ՐՏ_Index4++) {
                        s = ՐՏ_Iter4[ՐՏ_Index4];
    ...
    function do_import(key) {
        ...
        function safe_read(base_path) {
            var ՐՏ_Temp, i, path;
            var ՐՏ_Iter5 = ՐՏ_Iterable(enumerate([ base_path + ".pyj", base_path + "/__init__.pyj" ]));
            for (var ՐՏ_Index5 = 0; ՐՏ_Index5 < ՐՏ_Iter5.length; ՐՏ_Index5++) {
                var ՐՏ_Unpack5 = ՐՏ_Iter5[ՐՏ_Index5];
                i = ՐՏ_Unpack5[0];
                path = ՐՏ_Unpack5[1];
                try {
        ...
        modpath = key.replace(".", "/");
        var ՐՏ_Iter6 = ՐՏ_Iterable(import_dirs);
        for (var ՐՏ_Index6 = 0; ՐՏ_Index6 < ՐՏ_Iter6.length; ՐՏ_Index6++) {
            location = ՐՏ_Iter6[ՐՏ_Index6];
            if (location) {
                var ՐՏ_Unpack7 = safe_read(location + "/" + modpath);
                data = ՐՏ_Unpack7[0];
                filename = ՐՏ_Unpack7[1];
                if (data !== null) {
                    src_code = data;
                    break;
                }
    ...
    function import_(from_import) {
        ...
        var ՐՏ_Iter8 = ՐՏ_Iterable(ans["imports"]);
        for (var ՐՏ_Index8 = 0; ՐՏ_Index8 < ՐՏ_Iter8.length; ՐՏ_Index8++) {
            imp = ՐՏ_Iter8[ՐՏ_Index8];
            do_import(imp.key);
            ...
            if (from_import) {
                ...
                var ՐՏ_Iter9 = ՐՏ_Iterable(argnames);
                for (var ՐՏ_Index9 = 0; ՐՏ_Index9 < ՐՏ_Iter9.length; ՐՏ_Index9++) {
                    argvar = ՐՏ_Iter9[ՐՏ_Index9];
    ...
    function class_() {
        var ՐՏ_Temp, start, name, externaldecorator, class_details, definition, i, stmt, class_var_names, visitor;
        start = prev();
        ...
        visitor = new walker();
        var ՐՏ_Iter11 = ՐՏ_Iterable(definition.body);
        for (var ՐՏ_Index11 = 0; ՐՏ_Index11 < ՐՏ_Iter11.length; ՐՏ_Index11++) {
            stmt = ՐՏ_Iter11[ՐՏ_Index11];
    ...
    function function_(in_class, ctor) {
        var ՐՏ_Temp, start, is_accessor, name, generator, localvars, staticmethod, function_args, return_annotation, has_special_decorator, ctor, definition;
        start = prev();
    ...
    function expr_list(closing, allow_trailing_comma, allow_empty, func_call) {
        ...
        if (func_call) {
            tmp = [];
            tmp.kwargs = [];
            var ՐՏ_Iter12 = ՐՏ_Iterable(enumerate(a));
            for (var ՐՏ_Index12 = 0; ՐՏ_Index12 < ՐՏ_Iter12.length; ՐՏ_Index12++) {
                var ՐՏ_Unpack12 = ՐՏ_Iter12[ՐՏ_Index12];
                i = ՐՏ_Unpack12[0];
                arg = ՐՏ_Unpack12[1];
        ...
        if (commas) {
            ...
            while (is_("punc", ",") && !peek().nlb) {
                ...
                if (expr instanceof AST_Assign) {
                    ...
                    var ՐՏ_Iter13 = ՐՏ_Iterable(enumerate(leftAst.elements));
                    for (var ՐՏ_Index13 = 0; ՐՏ_Index13 < ՐՏ_Iter13.length; ՐՏ_Index13++) {
                        var ՐՏ_Unpack13 = ՐՏ_Iter13[ՐՏ_Index13];
                        index = ՐՏ_Unpack13[0];
                        element = ՐՏ_Unpack13[1];
            ...
            if (left.length > 1 && left[left.length-1] instanceof AST_Assign) {
                left[left.length-1] = left[left.length-1].left;
                var ՐՏ_Iter14 = ՐՏ_Iterable(enumerate(left));
                for (var ՐՏ_Index14 = 0; ՐՏ_Index14 < ՐՏ_Iter14.length; ՐՏ_Index14++) {
                    var ՐՏ_Unpack14 = ՐՏ_Iter14[ՐՏ_Index14];
                    index = ՐՏ_Unpack14[0];
                    element = ՐՏ_Unpack14[1];
            ...
            seq = function build_seq(a) {
                ...
                if (first instanceof AST_Assign) {
                    if (first.left instanceof AST_Array) {
                        var ՐՏ_Iter15 = ՐՏ_Iterable(enumerate(first.left.elements));
                        for (var ՐՏ_Index15 = 0; ՐՏ_Index15 < ՐՏ_Iter15.length; ՐՏ_Index15++) {
                            var ՐՏ_Unpack15 = ՐՏ_Iter15[ՐՏ_Index15];
                            index = ՐՏ_Unpack15[0];
                            element = ՐՏ_Unpack15[1];
