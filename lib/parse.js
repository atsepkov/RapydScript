...
function parse($TEXT, options) {
    ...
    if (options.classes) {
        var ՐՏ_Iter5 = ՐՏ_Iterable(options.classes);
        for (var ՐՏ_Index5 = 0; ՐՏ_Index5 < ՐՏ_Iter5.length; ՐՏ_Index5++) {
            cname = ՐՏ_Iter5[ՐՏ_Index5];
        ...
        if (Array.isArray(body)) {
            for (name in body) {
                ...
                if (obj instanceof AST_Function || obj instanceof AST_Class) {
                    ...
                    var ՐՏ_Iter6 = ՐՏ_Iterable([ "body", "alternative" ]);
                    for (var ՐՏ_Index6 = 0; ՐՏ_Index6 < ՐՏ_Iter6.length; ՐՏ_Index6++) {
                        x = ՐՏ_Iter6[ՐՏ_Index6];
                        opt = obj[x];
                        if (opt) {
    ...
    function do_import(key) {
        ...
        modpath = key.replace(".", "/");
        var ՐՏ_Iter8 = ՐՏ_Iterable([ options.basedir, options.libdir ]);
    ...
    import_ = function(from_import) {
        ...
        var ՐՏ_Iter9 = ՐՏ_Iterable(ans["imports"]);
        for (var ՐՏ_Index9 = 0; ՐՏ_Index9 < ՐՏ_Iter9.length; ՐՏ_Index9++) {
            imp = ՐՏ_Iter9[ՐՏ_Index9];
            do_import(imp.key);
            ...
            if (from_import) {
                ...
                var ՐՏ_Iter10 = ՐՏ_Iterable(argnames);
                for (var ՐՏ_Index10 = 0; ՐՏ_Index10 < ՐՏ_Iter10.length; ՐՏ_Index10++) {
                    argvar = ՐՏ_Iter10[ՐՏ_Index10];
    ...
    function_ = function(in_class, ctor) {
        ...
        nonlocals.forEach(function(variable) {
            var i;
            var ՐՏ_Iter11 = ՐՏ_Iterable(dir(definition.localvars).reverse());
    ...
    return function() {
        ...
        if (toplevel) {
            ...
            toplevel = new AST_Toplevel({
                ...
                strict: function() {
                    var stmt;
                    var ՐՏ_Iter13 = ՐՏ_Iterable(body);
