...
"use strict";
COMPILER_VERSION = "a2853a439d5eaf7d1e3f3b8818f24870cbe0faee";
...
function parse($TEXT, options) {
    ...
    import_ = function(from_import) {
        var ans, name, tmp, alias, imp, classes, argnames, bracketed, aname, argvar, obj, key, cname;
        ans = new AST_Imports({
            "imports": []
        });
        while (true) {
        ...
        for (var _$rapyd$_Index6 = 0; _$rapyd$_Index6 < _$rapyd$_Iter6.length; _$rapyd$_Index6++) {
            ...
            if (from_import) {
                ...
                var _$rapyd$_Iter7 = _$rapyd$_Iterable(argnames);
                for (var _$rapyd$_Index7 = 0; _$rapyd$_Index7 < _$rapyd$_Iter7.length; _$rapyd$_Index7++) {
                    argvar = _$rapyd$_Iter7[_$rapyd$_Index7];
                ...
                var _$rapyd$_Iter8 = _$rapyd$_Iterable(Object.keys(classes));
                for (var _$rapyd$_Index8 = 0; _$rapyd$_Index8 < _$rapyd$_Iter8.length; _$rapyd$_Index8++) {
                    cname = _$rapyd$_Iter8[_$rapyd$_Index8];
                    obj = classes[cname];
    ...
    function_ = function(in_class, ctor) {
        ...
        nonlocals.forEach(function(variable) {
            var i;
            var _$rapyd$_Iter9 = _$rapyd$_Iterable(dir(definition.localvars).reverse());
    ...
    function expr_list(closing, allow_trailing_comma, allow_empty, func_call) {
        ...
        if (func_call) {
            tmp = [];
            tmp.kwargs = [];
            var _$rapyd$_Iter10 = _$rapyd$_Iterable(enumerate(a));
