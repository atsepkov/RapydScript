...
function parse($TEXT, options) {
    ...
    if (options.classes) {
        var ՐՏ_Iter1 = ՐՏ_Iterable(options.classes);
        for (var ՐՏ_Index1 = 0; ՐՏ_Index1 < ՐՏ_Iter1.length; ՐՏ_Index1++) {
            cname = ՐՏ_Iter1[ՐՏ_Index1];
    ...
    function do_import(key) {
        ...
        function safe_read(base_path) {
            ...
            var ՐՏ_Iter3 = ՐՏ_Iterable(enumerate([ base_path + ".pyj", base_path + "/__init__.pyj" ]));
        ...
        modpath = key.replace(".", "/");
        var ՐՏ_Iter4 = ՐՏ_Iterable([ options.basedir, options.libdir ]);
        for (var ՐՏ_Index4 = 0; ՐՏ_Index4 < ՐՏ_Iter4.length; ՐՏ_Index4++) {
            location = ՐՏ_Iter4[ՐՏ_Index4];
            if (location) {
    ...
    import_ = function(from_import) {
        var ՐՏ_Unpack, name, key, classes, argnames, argvar, obj, i;
        ՐՏ_Unpack = read_import();
        name = ՐՏ_Unpack[0];
        key = ՐՏ_Unpack[1];
        argnames = null;
        ...
        if (from_import) {
            ...
            var ՐՏ_Iter5 = ՐՏ_Iterable(argnames);
            for (var ՐՏ_Index5 = 0; ՐՏ_Index5 < ՐՏ_Iter5.length; ՐՏ_Index5++) {
                argvar = ՐՏ_Iter5[ՐՏ_Index5];
    ...
    function_ = function(in_class, ctor) {
        ...
        nonlocals.forEach(function(variable) {
            var i;
            var ՐՏ_Iter6 = ՐՏ_Iterable(dir(definition.localvars).reverse());
            for (var ՐՏ_Index6 = 0; ՐՏ_Index6 < ՐՏ_Iter6.length; ՐՏ_Index6++) {
                i = ՐՏ_Iter6[ՐՏ_Index6];
    ...
    function expr_list(closing, allow_trailing_comma, allow_empty, func_call) {
        ...
        if (func_call) {
            tmp = [];
            tmp.kwargs = [];
            var ՐՏ_Iter7 = ՐՏ_Iterable(enumerate(a));
