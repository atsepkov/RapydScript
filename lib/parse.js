...
function parse($TEXT, options) {
    ...
    function do_import(key) {
        var package_module_id, modpath, _$rapyd$_Unpack, data, filename, src_code, location;
    ...
    import_ = function(from_import) {
        var ans, name, tmp, alias, imp, classes, argnames, bracketed, aname, argvar, obj, key, i;
        ans = new AST_Imports({
            "imports": []
        });
        while (true) {
        ...
        var _$rapyd$_Iter5 = _$rapyd$_Iterable(ans["imports"]);
        for (var _$rapyd$_Index5 = 0; _$rapyd$_Index5 < _$rapyd$_Iter5.length; _$rapyd$_Index5++) {
            imp = _$rapyd$_Iter5[_$rapyd$_Index5];
            do_import(imp.key);
            ...
            if (from_import) {
                ...
                var _$rapyd$_Iter6 = _$rapyd$_Iterable(argnames);
                for (var _$rapyd$_Index6 = 0; _$rapyd$_Index6 < _$rapyd$_Iter6.length; _$rapyd$_Index6++) {
                    argvar = _$rapyd$_Iter6[_$rapyd$_Index6];
    ...
    function_ = function(in_class, ctor) {
        ...
        nonlocals.forEach(function(variable) {
            var i;
            var _$rapyd$_Iter7 = _$rapyd$_Iterable(dir(definition.localvars).reverse());
