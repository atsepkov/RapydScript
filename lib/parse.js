...
BASELIB = {};
STDLIB = [ "abs", "bind", "rebind_all", "dir", "mixin", "print", "range", "getattr", "setattr", "hasattr", "enumerate", "filter", "len", "map", "reversed", "sum", "AssertionError", "IndexError", "TypeError", "ValueError" ];
...
function tokenizer($TEXT, filename) {
    ...
    function read_line_comment() {
        ...
        if (Object.prototype.hasOwnProperty.call(ՐՏ_kwargs_obj, "shebang")){
            shebang = ՐՏ_kwargs_obj.shebang;
        }
        var i, ret;
        if (!shebang) {
            next();
...
function parse($TEXT, options) {
    ...
    if (options.classes) {
        var ՐՏ_Iter6 = ՐՏ_Iterable(options.classes);
        for (var ՐՏ_Index6 = 0; ՐՏ_Index6 < ՐՏ_Iter6.length; ՐՏ_Index6++) {
            cname = ՐՏ_Iter6[ՐՏ_Index6];
        ...
        if (Array.isArray(body)) {
            for (name in body) {
                ...
                if (obj instanceof AST_Function || obj instanceof AST_Class) {
                    ...
                    var ՐՏ_Iter7 = ՐՏ_Iterable([ "body", "alternative" ]);
                    for (var ՐՏ_Index7 = 0; ՐՏ_Index7 < ՐՏ_Iter7.length; ՐՏ_Index7++) {
                        x = ՐՏ_Iter7[ՐՏ_Index7];
                        opt = obj[x];
                        if (opt) {
    ...
    function do_import(key) {
        ...
        function safe_read(base_path) {
            ...
            var ՐՏ_Iter8 = ՐՏ_Iterable(enumerate([ base_path + ".pyj", base_path + "/__init__.pyj" ]));
            for (var ՐՏ_Index8 = 0; ՐՏ_Index8 < ՐՏ_Iter8.length; ՐՏ_Index8++) {
                ՐՏ_Unpack = ՐՏ_Iter8[ՐՏ_Index8];
                i = ՐՏ_Unpack[0];
                path = ՐՏ_Unpack[1];
                try {
        ...
        modpath = key.replace(".", "/");
        var ՐՏ_Iter9 = ՐՏ_Iterable([ options.basedir, options.libdir ]);
        for (var ՐՏ_Index9 = 0; ՐՏ_Index9 < ՐՏ_Iter9.length; ՐՏ_Index9++) {
            location = ՐՏ_Iter9[ՐՏ_Index9];
            if (location) {
    ...
    function_ = function(in_class, ctor) {
        ...
        nonlocals.forEach(function(variable) {
            var i;
            var ՐՏ_Iter12 = ՐՏ_Iterable(dir(definition.localvars).reverse());
    ...
    function expr_list(closing, allow_trailing_comma, allow_empty, func_call) {
        ...
        if (func_call) {
            tmp = [];
            tmp.kwargs = [];
            var ՐՏ_Iter13 = ՐՏ_Iterable(enumerate(a));
