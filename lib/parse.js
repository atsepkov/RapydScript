...
BASELIB = {};
STDLIB = [ "abs", "bind", "rebind_all", "dir", "mixin", "print", "range", "getattr", "setattr", "hasattr", "eq", "enumerate", "filter", "len", "map", "reversed", "sum", "AssertionError", "IndexError", "TypeError", "ValueError" ];
