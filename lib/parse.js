...
function is_string_modifier(val) {
    ...
    for (var ՐՏ_Index10 = 0; ՐՏ_Index10 < ՐՏ_Iter10.length; ՐՏ_Index10++) {
        ...
        if (STRING_MODIFIERS.indexOf(ch) === -1) {
            return false;
        }
    }
    return true;
...
function tokenizer($TEXT, filename) {
    ...
    read_string = with_eof_error("Unterminated string constant", function(modifier) {
        var token_type, quote, i, tmp, find_newlines, octal_len, first, ch, ret;
        token_type = "string";
        if (modifier) {
            token_type += ":" + modifier;
        }
    ...
    function do_import(key) {
        ...
        function safe_read(base_path) {
            ...
            for (var ՐՏ_Index13 = 0; ՐՏ_Index13 < ՐՏ_Iter13.length; ՐՏ_Index13++) {
                var ՐՏ_Unpack = ՐՏ_Iter13[ՐՏ_Index13];
                i = ՐՏ_Unpack[0];
                path = ՐՏ_Unpack[1];
                try {
        ...
        modpath = key.replace(".", "/");
        var ՐՏ_Iter14 = ՐՏ_Iterable([ options.basedir, options.libdir ]);
    ...
    function expr_list(closing, allow_trailing_comma, allow_empty, func_call) {
        ...
        if (func_call) {
            ...
            for (var ՐՏ_Index20 = 0; ՐՏ_Index20 < ՐՏ_Iter20.length; ՐՏ_Index20++) {
                var ՐՏ_Unpack = ՐՏ_Iter20[ՐՏ_Index20];
                i = ՐՏ_Unpack[0];
                arg = ՐՏ_Unpack[1];
