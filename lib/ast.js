...
function DEFNODE(type, props, methods, base) {
    ...
    var ՐՏ_Iter6 = ՐՏ_Iterable(range(props.length - 1, -1, -1));
                ...
                if (value.TYPE) {
                    if (value.TYPE === "Token") {
                        if (compact) {
                            ...
                            var ՐՏ_Iter10 = ՐՏ_Iterable(value);
                            for (var ՐՏ_Index10 = 0; ՐՏ_Index10 < ՐՏ_Iter10.length; ՐՏ_Index10++) {
                                property = ՐՏ_Iter10[ՐՏ_Index10];
