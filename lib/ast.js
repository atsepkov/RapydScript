...
AST_Node = DEFNODE("Node", "start end", {
    ...
    dump: function() {
        var depth = (arguments[0] === undefined) ? (2) : arguments[0];
        var omit = (arguments[1] === undefined) ? ([]) : arguments[1];
        var compact = (arguments[2] === undefined) ? (false) : arguments[2];
        ...
        if (Object.prototype.hasOwnProperty.call(ՐՏ_kwargs_obj, "depth")){
            depth = ՐՏ_kwargs_obj.depth;
        }
        if (Object.prototype.hasOwnProperty.call(ՐՏ_kwargs_obj, "omit")){
            omit = ՐՏ_kwargs_obj.omit;
        }
        if (Object.prototype.hasOwnProperty.call(ՐՏ_kwargs_obj, "compact")){
            compact = ՐՏ_kwargs_obj.compact;
        }
