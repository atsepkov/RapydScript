...
AST_Node = DEFNODE("Node", "start end", {
    ...
    dump: function(depth, omit, compact) {
        ...
        compact = compact === undefined ? false : compact;
        var ՐՏ_Temp;
...
AST_Seq = DEFNODE("Seq", "car cdr", {
    ...
    $from_array: function(array) {
        ...
        list = null;
        var ՐՏ_Iter5 = ՐՏ_Iterable(range(array.length - 1, -1, -1));
        for (var ՐՏ_Index5 = 0; ՐՏ_Index5 < ՐՏ_Iter5.length; ՐՏ_Index5++) {
            i = ՐՏ_Iter5[ՐՏ_Index5];
...
TreeWalker.prototype = {
    ...
    find_parent: function(type) {
        ...
        stack = this.stack;
        var ՐՏ_Iter6 = ՐՏ_Iterable(range(stack.length - 1, -1, -1));
    ...
    loopcontrol_target: function(label) {
        ...
        stack = this.stack;
        if (label) {
            var ՐՏ_Iter7 = ՐՏ_Iterable(range(stack.length - 1, -1, -1));
            ...
            var ՐՏ_Iter8 = ՐՏ_Iterable(range(stack.length - 1, -1, -1));
