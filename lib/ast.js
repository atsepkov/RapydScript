...
AST_Lambda = DEFNODE("Lambda", "name argnames kwargs uses_arguments decorators generator return_annotation", {
    ...
    _walk: function(visitor) {
        ...
        return visitor._visit(node, function() {
            var ՐՏ_Temp, d;
            if (node.decorators) {
                var ՐՏ_Iter7 = ՐՏ_Iterable(node.decorators);
...
AST_Function = DEFNODE("Function", null, {
    ...
    resolveType: function(heap) {
        ...
        annotated = true;
        args = [];
        var ՐՏ_Iter8 = ՐՏ_Iterable(this.argnames);
        for (var ՐՏ_Index8 = 0; ՐՏ_Index8 < ՐՏ_Iter8.length; ՐՏ_Index8++) {
            arg = ՐՏ_Iter8[ՐՏ_Index8];
            if (arg.annotation) {
...
AST_Except = DEFNODE("Except", "argname errors", {
    ...
    _walk: function(visitor) {
        ...
        return visitor._visit(node, function() {
            ...
            if (node.errors) {
                var ՐՏ_Iter9 = ՐՏ_Iterable(node.errors);
                for (var ՐՏ_Index9 = 0; ՐՏ_Index9 < ՐՏ_Iter9.length; ՐՏ_Index9++) {
                    e = ՐՏ_Iter9[ՐՏ_Index9];
                    e.walk(visitor);
                }
            }
            walk_body(node, visitor);
...
AST_Seq = DEFNODE("Seq", "car cdr", {
    ...
    $from_array: function(array) {
        ...
        list = null;
        var ՐՏ_Iter11 = ՐՏ_Iterable(range(array.length - 1, -1, -1));
...
AST_Array = DEFNODE("Array", "elements", {
    ...
    resolveType: function(heap) {
        ...
        var ՐՏ_Iter12 = ՐՏ_Iterable(this.elements.slice(1));
...
AST_Object = DEFNODE("Object", "properties", {
    ...
    resolveType: function(heap) {
        ...
        var ՐՏ_Iter13 = ՐՏ_Iterable(this.properties.slice(start + 1));
...
AST_SymbolRef = DEFNODE("SymbolRef", "parens", {
    ...
    resolveType: function(heap) {
        var ՐՏ_Temp, scope;
        var ՐՏ_Iter14 = ՐՏ_Iterable(reversed(heap));
        for (var ՐՏ_Index14 = 0; ՐՏ_Index14 < ՐՏ_Iter14.length; ՐՏ_Index14++) {
            scope = ՐՏ_Iter14[ՐՏ_Index14];
...
TreeWalker.prototype = {
    ...
    loopcontrol_target: function(label) {
        ...
        if (label) {
            ...
            var ՐՏ_Iter17 = ՐՏ_Iterable(range(stack.length - 1, -1, -1));
