...
AST_Import = DEFNODE("Import", "module basedir path as argnames variables body", {
    $documentation: "Container for imported files",
    $propdoc: {
        "module": "[AST_SymbolVar] name of the module we're importing",
        basedir: "[AST_SymbolVar] base directoryt of the module we're importing",
        path: "[AST_SymbolVar] relative filname of the module we're importing",
...
AST_Function = DEFNODE("Function", "public", {
    $documentation: "A function expression",
    $propdoc: {
        "public": "[boolean] true if function is declared public and should be exported from the AMD module"
    }
}, AST_Lambda);
AST_Class = DEFNODE("Class", "init name parent static external public bound decorators modules", {
    ...
    $propdoc: {
        ...
        "public": "[boolean] true if class is declared public and should be exported from the AMD module",
...
AST_SymbolRef = DEFNODE("SymbolRef", "public", {
    $documentation: "Reference to some symbol (not definition/declaration)",
    $propdoc: {
        "public": "[boolean] true if symbol is declared public and should be exported from the AMD module"
    }
}, AST_Symbol);
