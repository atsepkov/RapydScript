...
AST_Token = DEFNODE("Token", "type value line col pos endpos newline_before comments_before file", {}, null);
...
AST_Lambda = DEFNODE("Lambda", "name argnames kwargs uses_arguments decorators generator return_annotation", {
    ...
    _walk: function(visitor) {
        ...
        return visitor._visit(node, function() {
            ...
            var d;
            if (node.decorators) {
                ՐՏitr6 = ՐՏ_Iterable(node.decorators);
...
AST_Function = DEFNODE("Function", null, {
    ...
    resolveType: function(heap) {
        var ՐՏitr7, ՐՏidx7;
        var parse, annotated, args, arg, computedType, result, signature;
        parse = function(variable) {
            ...
            if (variable instanceof AST_Array) {
                ...
                if (1 <= (ՐՏ_3 = variable.args.length) && ՐՏ_3 <= 2) {
        ...
        annotated = true;
        args = [];
        ՐՏitr7 = ՐՏ_Iterable(this.argnames);
...
AST_Except = DEFNODE("Except", "argname errors", {
    ...
    _walk: function(visitor) {
        ...
        return visitor._visit(node, function() {
            ...
            if (node.errors) {
                ՐՏitr8 = ՐՏ_Iterable(node.errors);
...
AST_Call = DEFNODE("Call", "expression", {
    ...
    resolveType: function(heap) {
        ...
        if (this.expression instanceof AST_SymbolRef) {
            ՐՏitr9 = ՐՏ_Iterable(reversed(heap));
...
AST_Seq = DEFNODE("Seq", "car cdr", {
    ...
    $from_array: function(array) {
        ...
        list = null;
        ՐՏitr10 = ՐՏ_Iterable(range(array.length - 1, -1, -1));
...
AST_Array = DEFNODE("Array", "elements", {
    ...
    resolveType: function(heap) {
        ...
        ՐՏitr11 = ՐՏ_Iterable(this.elements.slice(1));
        for (ՐՏidx11 = 0; ՐՏidx11 < ՐՏitr11.length; ՐՏidx11++) {
            element = ՐՏitr11[ՐՏidx11];
...
AST_Object = DEFNODE("Object", "properties", {
    ...
    resolveType: function(heap) {
        ...
        ՐՏitr12 = ՐՏ_Iterable(this.properties.slice(start + 1));
        for (ՐՏidx12 = 0; ՐՏidx12 < ՐՏitr12.length; ՐՏidx12++) {
            element = ՐՏitr12[ՐՏidx12];
...
AST_SymbolRef = DEFNODE("SymbolRef", "parens", {
    ...
    resolveType: function(heap) {
        var ՐՏitr13, ՐՏidx13;
        var scope;
        ՐՏitr13 = ՐՏ_Iterable(reversed(heap));
        for (ՐՏidx13 = 0; ՐՏidx13 < ՐՏitr13.length; ՐՏidx13++) {
            scope = ՐՏitr13[ՐՏidx13];
...
TreeWalker.prototype = {
    ...
    find_parent: function(type) {
        ...
        var stack, i, x;
        stack = this.stack;
        ՐՏitr14 = ՐՏ_Iterable(range(stack.length - 1, -1, -1));
    ...
    loopcontrol_target: function(label) {
        ...
        stack = this.stack;
        if (label) {
            ՐՏitr15 = ՐՏ_Iterable(range(stack.length - 1, -1, -1));
            ...
            ՐՏitr16 = ՐՏ_Iterable(range(stack.length - 1, -1, -1));
