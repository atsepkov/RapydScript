...
function OutputStream(options) {
    ...
    function spaced() {
        ...
        var _$rapyd$_Iter10 = _$rapyd$_Iterable(enumerate(arguments));
    ...
    function prologue(module_) {
        ...
        if (!options.omit_baselib) {
            var _$rapyd$_Iter11 = _$rapyd$_Iterable(module_.baselib);
            for (var _$rapyd$_Index11 = 0; _$rapyd$_Index11 < _$rapyd$_Iter11.length; _$rapyd$_Index11++) {
                lib = _$rapyd$_Iter11[_$rapyd$_Index11];
                dump_baselib(lib);
            }
        }
    }
...
(function() {
    ...
    function write_imports(module_, output) {
        ...
        imports = [];
        var _$rapyd$_Iter12 = _$rapyd$_Iterable(Object.keys(module_.imports));
        for (var _$rapyd$_Index12 = 0; _$rapyd$_Index12 < _$rapyd$_Iter12.length; _$rapyd$_Index12++) {
            import_id = _$rapyd$_Iter12[_$rapyd$_Index12];
        ...
        nonlocalvars = {};
        var _$rapyd$_Iter13 = _$rapyd$_Iterable(imports);
        for (var _$rapyd$_Index13 = 0; _$rapyd$_Index13 < _$rapyd$_Iter13.length; _$rapyd$_Index13++) {
            module_ = _$rapyd$_Iter13[_$rapyd$_Index13];
            var _$rapyd$_Iter14 = _$rapyd$_Iterable(module_.nonlocalvars);
            for (var _$rapyd$_Index14 = 0; _$rapyd$_Index14 < _$rapyd$_Iter14.length; _$rapyd$_Index14++) {
                name = _$rapyd$_Iter14[_$rapyd$_Index14];
        ...
        if (node instanceof AST_Scope) {
            if (node.argnames) {
                if (node.argnames.is_simple_func !== true) {
                    ...
                    var _$rapyd$_Iter17 = _$rapyd$_Iterable(enumerate(a));
                    ...
                    if (a.kwargs || a.has_defaults) {
                        ...
                        output.end_statement();
                        if (a.has_defaults) {
                            var _$rapyd$_Iter18 = _$rapyd$_Iterable(Object.keys(a.defaults));
                            for (var _$rapyd$_Index18 = 0; _$rapyd$_Index18 < _$rapyd$_Iter18.length; _$rapyd$_Index18++) {
                                dname = _$rapyd$_Iter18[_$rapyd$_Index18];
                                output.indent();
    ...
    function declare_exports(module_id, exports, submodules, output) {
        ...
        seen = {};
        var _$rapyd$_Iter19 = _$rapyd$_Iterable(exports);
        for (var _$rapyd$_Index19 = 0; _$rapyd$_Index19 < _$rapyd$_Iter19.length; _$rapyd$_Index19++) {
            symbol = _$rapyd$_Iter19[_$rapyd$_Index19];
            output.newline();
            output.indent();
        ...
        var _$rapyd$_Iter20 = _$rapyd$_Iterable(submodules);
        for (var _$rapyd$_Index20 = 0; _$rapyd$_Index20 < _$rapyd$_Iter20.length; _$rapyd$_Index20++) {
            sub_module_id = _$rapyd$_Iter20[_$rapyd$_Index20];
