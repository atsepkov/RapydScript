        ...
        return function(obj) {
            ...
            output.with_block(function() {
                ...
                Object.keys(props).forEach(function(key, i) {
                    ...
                    output.with_block(function() {
                        var ՐՏ_Temp, attr;
                        var ՐՏ_Iter1 = ՐՏ_Iterable([ "enumerable", "writable" ]);
                        for (var ՐՏ_Index1 = 0; ՐՏ_Index1 < ՐՏ_Iter1.length; ՐՏ_Index1++) {
                            attr = ՐՏ_Iter1[ՐՏ_Index1];
                            output.indent();
                            output.print(attr);
                            output.colon();
                            output.print("true");
...
(function() {
    ...
    function tempVar(subtype) {
        subtype = subtype === void 0 ? "" : subtype;
        var ՐՏ_Temp;
        ++tmp_index;
    ...
    function write_imports(module_, output) {
        ...
        imports = [];
        var ՐՏ_Iter3 = ՐՏ_Iterable(Object.keys(module_.imports));
        for (var ՐՏ_Index3 = 0; ՐՏ_Index3 < ՐՏ_Iter3.length; ՐՏ_Index3++) {
            import_id = ՐՏ_Iter3[ՐՏ_Index3];
            imports.push(module_.imports[import_id]);
        }
        imports.sort(function(a, b) {
            var ՐՏ_Temp, a, b;
            var ՐՏ_Unpack4 = [ a.import_order, b.import_order ];
            a = ՐՏ_Unpack4[0];
            b = ՐՏ_Unpack4[1];
        ...
        for (var ՐՏ_Index5 = 0; ՐՏ_Index5 < ՐՏ_Iter5.length; ՐՏ_Index5++) {
            ...
            var ՐՏ_Iter6 = ՐՏ_Iterable(module_.nonlocalvars);
            for (var ՐՏ_Index6 = 0; ՐՏ_Index6 < ՐՏ_Iter6.length; ՐՏ_Index6++) {
                name = ՐՏ_Iter6[ՐՏ_Index6];
        ...
        var ՐՏ_Iter7 = ՐՏ_Iterable(imports);
        for (var ՐՏ_Index7 = 0; ՐՏ_Index7 < ՐՏ_Iter7.length; ՐՏ_Index7++) {
            module_ = ՐՏ_Iter7[ՐՏ_Index7];
        ...
        var ՐՏ_Iter8 = ՐՏ_Iterable(imports);
        for (var ՐՏ_Index8 = 0; ՐՏ_Index8 < ՐՏ_Iter8.length; ՐՏ_Index8++) {
            module_ = ՐՏ_Iter8[ՐՏ_Index8];
            if (module_.module_id !== "__main__") {
    ...
    function declare_exports(module_id, exports, submodules, output) {
        ...
        seen = {};
        var ՐՏ_Iter9 = ՐՏ_Iterable(exports);
        for (var ՐՏ_Index9 = 0; ՐՏ_Index9 < ՐՏ_Iter9.length; ՐՏ_Index9++) {
            symbol = ՐՏ_Iter9[ՐՏ_Index9];
            output.newline();
            output.indent();
        ...
        var ՐՏ_Iter10 = ՐՏ_Iterable(submodules);
        for (var ՐՏ_Index10 = 0; ՐՏ_Index10 < ՐՏ_Iter10.length; ՐՏ_Index10++) {
            sub_module_id = ՐՏ_Iter10[ՐՏ_Index10];
    ...
    AST_Lambda.DEFMETHOD("_do_print", function(output, nokeyword) {
        ...
        var internalsub = (ՐՏ13 = function internalsub() {
            var ՐՏ_Temp;
            if (!nokeyword) {
                output.print("function");
                if (self.generator) {
        ...
        }, ՐՏ13 = unify(output, name, addDecorators(), addDocstring())(ՐՏ13), ՐՏ13);
        internalsub();
    });
    ...
    AST_Class.DEFMETHOD("_do_print", function(output) {
        var ՐՏ_Temp, self, define_method, methods, staticmethods, name;
        self = this;
        if (self.external) {
            return;
        }
        ...
        function addMethods() {
            var ՐՏ_Temp, methods, static, methodOutput, staticMethodOutput;
            methods = {};
            static = {};
            if (self.docstring) {
        ...
        var ՐՏ_Unpack14 = addMethods();
        methods = ՐՏ_Unpack14[0];
        staticmethods = ՐՏ_Unpack14[1];
        name = null;
        if (self.name) {
            name = "var " + self.name.name;
        }
        
        var generateClass = (ՐՏ15 = function generateClass() {
            var ՐՏ_Temp;
        ...
        }, ՐՏ15 = unify(output, name, addInheritance(), addDecorators(), methods, staticmethods)(ՐՏ15), ՐՏ15);
        generateClass();
    });
    ...
    DEFPRINT(AST_BaseCall, function(self, output) {
        ...
        if (self.args.starargs) {
            ...
            output.with_parens(function() {
                var ՐՏ_Temp, arg;
                obj.print(output);
                var ՐՏ_Iter16 = ՐՏ_Iterable(self.args);
                for (var ՐՏ_Index16 = 0; ՐՏ_Index16 < ՐՏ_Iter16.length; ՐՏ_Index16++) {
                    arg = ՐՏ_Iter16[ՐՏ_Index16];
                    output.comma();
                    arg.print(output);
                }
                output.comma();
    ...
    DEFPRINT(AST_Range, function(self, output) {
        var ՐՏ_Temp, start, end, step;
        if (self.left instanceof AST_Number && self.right instanceof AST_Number && Math.abs(self.right.value - self.left.value) < 50) {
            start = parseFloat(self.left.value);
            end = parseFloat(self.right.value);
            step = start < end ? 1 : -1;
            if (self.operator === "to") {
                end += step / 1e6;
            }
            output.with_square(function() {
                var ՐՏ_Temp, i;
                var ՐՏ_Iter17 = ՐՏ_Iterable(range(start, end, step));
                for (var ՐՏ_Index17 = 0; ՐՏ_Index17 < ՐՏ_Iter17.length; ՐՏ_Index17++) {
                    i = ՐՏ_Iter17[ՐՏ_Index17];
                    if (i !== start) {
                        output.comma();
                    }
                    output.print(i);
    ...
    function first_in_statement(output) {
        var ՐՏ_Temp, processed, i, node, prev;
