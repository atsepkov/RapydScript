...
function OutputStream(options) {
    ...
    function spaced() {
        ...
        var _$rapyd$_Iter1 = _$rapyd$_Iterable(enumerate(arguments));
    ...
    function prologue(module_) {
        ...
        if (!options.omit_baselib) {
            var _$rapyd$_Iter2 = _$rapyd$_Iterable(module_.baselib);
            for (var _$rapyd$_Index2 = 0; _$rapyd$_Index2 < _$rapyd$_Iter2.length; _$rapyd$_Index2++) {
                lib = _$rapyd$_Iter2[_$rapyd$_Index2];
                dump_baselib(lib);
            }
        }
    }
...
(function() {
    ...
    function write_imports(module_, output) {
        ...
        imports = [];
        var _$rapyd$_Iter3 = _$rapyd$_Iterable(Object.keys(module_.imports));
    ...
    DEFPRINT(AST_Import, function(self, output) {
        ...
        if (self.argnames) {
            var _$rapyd$_Iter12 = _$rapyd$_Iterable(self.argnames);
            for (var _$rapyd$_Index12 = 0; _$rapyd$_Index12 < _$rapyd$_Iter12.length; _$rapyd$_Index12++) {
                argname = _$rapyd$_Iter12[_$rapyd$_Index12];
