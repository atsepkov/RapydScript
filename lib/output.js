...
function OutputStream(options) {
    ...
    function dump_baselib(key) {
        ...
        lib = {
            ...
            "iterable": function() {
                return func_gen("_$rapyd$_Iterable", {
                    args: [ "iterable" ],
                    body: [ [ "if", {
                        parens: [ "iterable", "instanceof", "Array", "||", "iterable", "instanceof", "String", "||", "typeof", "iterable", "===", "'string'" ]
                    }, "return", "iterable" ], [ "return", "Object.keys", {
                        call: [ "iterable" ]
                    } ] ]
                });
            },
...
(function() {
    ...
    DEFPRINT(AST_Splice, function(self, output) {
        ...
        output.with_parens(function() {
            ...
            output.with_square(function() {
                var start, count;
                start = self.property.value;
                count = self.property2.value - self.property.value;
                output.print(start);
                output.comma();
                output.print(count);
            });
